@push('stylesheet')
    <link rel="stylesheet" href="{{ asset('css/env-news-detail-page.css') }}">
@endpush

<div class="news-detail-page">
    <div class="container">
        <div class="page-path-section">
            <span class="base-path"><a href="/">Milenium Environment</a></span>
        ...
        <div class="section-title">
            <span class="title">Milenium Environment</span>
            @if ($post->category)
