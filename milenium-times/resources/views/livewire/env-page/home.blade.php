@push('stylesheet')
    <link rel="stylesheet" href="{{ asset('css/env-homepage.css') }}">
@endpush
    ...
    @endif
        ...
        <div class="container">
            <div class="header-logo-container">
                ...
                <span class="brand">Milenium <span>Environment</span></span>
            </div>
            <div id="home-content-nav" class="header-nav">
                <span class="sport-nav"><a href="{{ route('sport-home') }}">Sport</a></span>
                <span class="active env-nav"><a href="{{ route('env-home') }}">Environment</a></span>
