        ...
        <div class="content-card">
            <div class="content-header">
                <div class="content-title history">
                    <span>History Page Wallpaper</span>
                </div>
            </div>
            ...
            <div class="content-body"
                ...
                <div class="image-container">
                    ...
                    @if ($image)
                        ...
                        @if ($upload_status)
                            <img src="{{ $image->temporaryUrl() }}" alt="milenium-history-bg">                        
                        @else
                            <img src="{{ asset('storage/'.$image) }}" alt="milenium-history-bg">
                        @endif
                    ...
                    @else
                        <div class="no-image" :class="isUploading ? 'uploading' : ''">
                            ...
                            <div class="button-container">
                                <button class="input-image-button history" onclick="$('#input-image').click()">Tambahkan Gambar</button>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="progress" :class="isUploading ? 'show' : ''">
                        <div class="progress-bar history" role="progressbar" x-bind:style="`width: ${progress}%`" x-bind:aria-valuenow="`${progress}`" aria-valuemin="0" aria-valuemax="100" x-text="progress"></div>
                    </div>
                    
                </div>
                <div class="button-wrapper" :class="isUploading ? 'disabled' : ''">
                    <button wire:click='save_changes' type="button" class="primary-btn history">Simpan</button>
                </div>
            </div>
        </div>
