    ...
    <div class="container">
        <div class="content-card">
            ...
            <div class="add-pages">
                ...
                <select wire:model='select_page' class="form-select" aria-label="Create Post For Pages">
                    <option selected hidden>Pilih halaman</option>
                    @foreach ($pages as $page)
                        <option value="{{ $page->id }}">{{ $page->name }}</option>
                    @endforeach
                </select>
            </div>
            <div id="main-input" class="main-input" wire:ignore.self>
                ...
                <div class="input-body-news" wire:ignore>
                    <div id="body-news-editor"></div>
                </div>
                <div class="button-wrapper">
                    {{-- <button class="delete-button">Hapus</button> --}}
                    <button wire:click='validate_data' class="post-button">Posting</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="modal-button confirm-button" wire:click='store_data'>Posting</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    // Updated Select Page.. check if true = open the input field
    $(window).on('open-input-field', function () {
        const mainInput = $('#main-input');
        if (event.detail.status) {
            mainInput.addClass('show');
        }
        else {
            mainInput.removeClass('show');
        }
    });
