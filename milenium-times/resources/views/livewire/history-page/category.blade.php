@push('stylesheet')
    <link rel="stylesheet" href="{{ asset('css/history-categorypage.css') }}">
@endpush

<div class="category-page">
    <div class="container">
        <div class="page-path-section">
            <span class="base-path"><a href="/">Milenium History</a></span>
            <i class="fa-sharp fa-solid fa-angle-right"></i>
            <span class=""><a href="{{ route('history-news') }}">Berita</a></span>
            <i class="fa-sharp fa-solid fa-angle-right"></i>
