@push('stylesheet')
    <link rel="stylesheet" href="{{ asset('css/history-homepage.css') }}">
@endpush
...
<div class="homepage">
    ...
    @endif
        ...
        <div class="container">
            <div class="header-logo-container">
                ...
                <span class="brand">Milenium <span>History</span></span>
            </div>
            <div id="home-content-nav" class="header-nav">
                <span class="sport-nav"><a href="{{ route('sport-home') }}">Sport</a></span>
                <span class="env-nav"><a href="{{ route('env-home') }}">Environment</a></span>
                <span class="active history-nav"><a href="{{ route('history-home') }}">History</a></span>
            </div>
            <div class="header-content">
                <div class="main-content">
                    ...
                    <div class="details-container">
                        ...
                        @if ($newest_post_hero)
                            <a class="details-title" href="post/{{ $newest_post_hero->id }}-{{ $newest_post_hero->title_slug }}">{{ $newest_post_hero->title }}</a>
                            <span class="details-date">{{ $this->translate_date($newest_post_hero->created_at) }}</span>
                ...
                <div class="suggestion">
                    @forelse ($newest_posts as $post)
                        <div class="suggestion-items">
                            <a class="title" href="post/{{ $post->id }}-{{ $post->title_slug }}">{{ $post->title }}</a>
    ...
    <div class="content-section">
        <div class="container">
            ...
            <div class="slot-2">
                {{-- Left Side --}}
                <livewire:components.home.update-post :class="'left-side'" :pageId="$PAGE_ID"/>
