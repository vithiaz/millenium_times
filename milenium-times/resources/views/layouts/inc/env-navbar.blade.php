    ...
    <div class="container">
        <div id="nav-logo" class="logo">
            ...
            <div class="brand">
                ...
                <span class="page">Environment</span>
                <i class="fa-sharp fa-solid fa-angle-down"></i>
            </div>
        </div>
        <div id="nav-logo-shadow"></div>
        <div id="nav-menu" class="menu">
            <span><a href="/">Beranda</a><div class="line"></div></span>
            <span><a href="/news">Berita</a><div class="line"></div></span>
            <span><a href="/gallery">Gallery</a><div class="line"></div></span>
            <span class="search-menu-hidden">
                <i class="fa-solid fa-magnifying-glass"></i>
            </span>
        </div>

        {{-- Search Bar                 *pageId 2 == EnvPage --}}
        <livewire:components.search-bar :pageId='2' />
