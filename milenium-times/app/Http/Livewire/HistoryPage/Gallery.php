...
class Gallery extends Component
{
    ...
    {
        $this->gallery_query = Post::with('category')->where('page_id', '=', $this->PAGE_ID);
        ...
        return view('livewire.history-page.gallery', ['galleries' => $this->render_gallery, 'more_post' => $disable_load_btn])->layout('layouts.history');
    }
